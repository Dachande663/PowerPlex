...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlexLibrary = __webpack_require__(159);

	var _PlexLibrary2 = _interopRequireDefault(_PlexLibrary);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_PlexLibrary2.default, { data: '/data.json' }), document.getElementById('library'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlexItems = __webpack_require__(160);

	var _PlexItems2 = _interopRequireDefault(_PlexItems);

	var _pourover = __webpack_require__(162);

	var _pourover2 = _interopRequireDefault(_pourover);
	...
	exports.default = _react2.default.createClass({
		...
		loadItems: function loadItems() {
			...
			jQuery.getJSON("/assets/test/data.json", function (resp) {
				...
				var collection = new _pourover2.default.Collection(items);

				var type_filter = _pourover2.default.makeExactFilter('Type', ['movie', 'show', 'season', 'episode']);
				collection.addFilters([type_filter]);

				var NameSort = _pourover2.default.Sort.extend({
					fn: function fn(a, b) {
				...
				var RatingSort = _pourover2.default.Sort.extend({
					fn: function fn(a, b) {
				...
				var YearSort = _pourover2.default.Sort.extend({
					fn: function fn(a, b) {
				...
				collection.addSorts([new NameSort('Title'), new RatingSort('Rating'), new YearSort('Year')]);

				var view = new _pourover2.default.View('default_view', collection, { page_size: 500 });
		...
		onClickSort: function onClickSort(sort, e) {
			e.preventDefault();
			var view = this.state.items;
			view.setSort(sort);
			this.setState({ items: view });
		},
		onClickType: function onClickType(type, e) {
			e.preventDefault();
			var view = this.state.items;
		...
		render: function render() {
			return _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: '#', onClick: this.onClickSort.bind(this, 'Title') },
										'Name'
									)
								),
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: '#', onClick: this.onClickSort.bind(this, 'Rating') },
										'Rating'
									)
								),
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: '#', onClick: this.onClickSort.bind(this, 'Year') },
										'Year'
									)
								)
							)
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: '#', onClick: this.onClickType.bind(this, 'movie') },
										'Movie'
									)
								),
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: '#', onClick: this.onClickType.bind(this, 'show') },
										'Show'
									)
								),
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: '#', onClick: this.onClickType.bind(this, 'season') },
										'Season'
									)
								),
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: '#', onClick: this.onClickType.bind(this, 'episode') },
										'Episode'
									)
								)
							)
				...
				_react2.default.createElement(
					'div',
					{ className: 'col-md-9' },
					_react2.default.createElement(_PlexItems2.default, { items: this.state.items })
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlexItem = __webpack_require__(161);

	var _PlexItem2 = _interopRequireDefault(_PlexItem);

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var _reactMasonryComponent = __webpack_require__(164);

	var _reactMasonryComponent2 = _interopRequireDefault(_reactMasonryComponent);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var MasonryContainer = (0, _reactMasonryComponent2.default)(_react2.default);

	exports.default = _react2.default.createClass({
		displayName: 'PlexItems',
		render: function render() {
			var nodes = this.props.items ? this.props.items.getCurrentItems().map(function (item) {
				return _react2.default.createElement(_PlexItem2.default, { key: item.Key, item: item });
			}) : [];
			return _react2.default.createElement(
				MasonryContainer,
				null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Masonry = isBrowser ? window.Masonry || __webpack_require__(165) : null;
	var imagesloaded = isBrowser ? __webpack_require__(178) : null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// transport
	if ( true ) {
	  module.exports = defineDocReady( __webpack_require__(169) );
	} else if ( typeof define === 'function' && define.amd ) {
	  // AMD
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ( true ) {
	  ...
	  module.exports = defineGetSize( __webpack_require__(172) );
	} else if ( typeof define === 'function' && define.amd ) {
	  // AMD for RequireJS
